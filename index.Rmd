...
### 1.Yearly Fluctuations of P&I (Pneumonia and Influenza) death rates and flu vaccination rates

```{r, out.width ="75%", out.height= "75%", echo=FALSE}
f3 <- ggplot(combined_dat, aes(x = season)) +
  ...
  scale_color_manual(
    ...
    name = "") +
  ggtitle("Fully Flu Vaccination and P&I Deaths Proportion by Year(2009-2019)") +
  labs(
    x = "Year",
    y = "Proportion (%)",
    color = "Legend"
...
### 2.The  between P&I (Pneumonia and Influenza) death rates and flu vaccination rates
